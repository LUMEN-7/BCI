...
function deBlocosParaNota(anotacao) {
    ...
    return {
        ...
        savedCars: carrosBlocos.map((b) => ({
            ...
            image: b.cardCarro.imagemUrl ?? b.cardCarro.image ?? b.cardCarro.imagem ?? null,
            year: b.cardCarro.ano ?? b.cardCarro.year ?? '',
            engine: b.cardCarro.motor ?? b.cardCarro.engine ?? '',
            power: b.cardCarro.potencia ?? b.cardCarro.power ?? '',
            type: b.cardCarro.categoria ?? b.cardCarro.type ?? '',
        })),
