  ...
  return (
    <>
      <header className="saved-header">
        <div>
          <span className="saved-eyebrow">Minha coleção</span>
          <h1>Salvos</h1>
          <p>
            Acesse rapidamente seus veículos favoritos e comparações salvas.
          </p>
        </div>
      </header>
      <div className="saved-tabs">
        ...
        <button
          ...
          onClick={() => onChangeTab("comparisons")}
        >
          <IoGitCompareOutline />
...
export function SavedAttention() {
  return (
    <div className="saved-attention">
      ...
      <div>
        ...
        <span>Alguns itens salvos possuem informações novas.</span>
      </div>
    </div>
  );
}
