...
export default function Notes() {
	...
	return <main className="notes-page">
		...
		<section className="notes-container">
			...
			<NotesToolbar search={controller.search} onSearch={controller.setSearch} />
			<NotesGrid notes={controller.filteredNotes} search={controller.search} onDelete={controller.handleDelete} onOpen={controller.handleOpen} onCreate={controller.handleCreate} />
		</section>
	</main>;
}
