...
export default function Profile() {
	...
	return <main className="profile-page">
		<section className="profile-container">
			...
			<ProfileHero name={controller.displayName} email={controller.displayEmail} photo={controller.profilePhoto} />
			<ProfileSettings items={controller.menuItems} onNavigate={controller.handleMenuNavigate} />
