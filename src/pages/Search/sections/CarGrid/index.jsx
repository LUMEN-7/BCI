...
export default function CarGrid({ cars, favorites, onToggleFavorite, onDetails }) {
    return (
                ...
                <article key={car.id} className="car-card">
                    <div className="card-top">
                        ...
                        <button
                            ...
                            aria-label={favorites.includes(car.id) ? 'Remover dos favoritos' : 'Adicionar aos favoritos'}
                        >
